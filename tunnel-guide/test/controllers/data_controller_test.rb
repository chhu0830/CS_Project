...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { distance: @datum.distance, ip: @datum.ip, mac: @datum.mac, speed: @datum.speed } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { distance: @datum.distance, ip: @datum.ip, mac: @datum.mac, speed: @datum.speed } }
